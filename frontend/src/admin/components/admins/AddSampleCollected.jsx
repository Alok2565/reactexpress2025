...
// export default AddSampleCollected
...
function AddSampleCollected() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("http://localhost:5000/api/samples_collected", insertData);
            navigate("/admin/samples-collected?success=Samples Collected%20has%20been%20created%20successfully");
        } catch (error) {
